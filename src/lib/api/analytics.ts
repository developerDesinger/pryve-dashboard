...
class AnalyticsAPI {
  ...
  async getEmotionsAnalytics(): Promise<
    ApiResponse<EmotionsAnalyticsResponse>
  > {
    return this.request<EmotionsAnalyticsResponse>(
      API_CONFIG.ENDPOINTS.ANALYTICS_EMOTIONS,
      {
        method: "GET",
      }
    );
